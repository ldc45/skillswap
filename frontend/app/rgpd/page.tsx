...
const RgpdPage: FC = () => {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-900 dark:text-gray-100">
      {/* Page title */}
      <h1 className="text-3xl font-bold mb-4">Politique de confidentialité (RGPD)</h1>
      {/* Subtitle */}
      ...
      <p className="mb-4">
        ...
        Les informations collectées sont utilisées uniquement dans le cadre du fonctionnement de la plateforme et ne sont jamais revendues à des tiers.
      </p>
      ...
      <p className="mb-4">
        Pour exercer vos droits ou pour toute question concernant vos données, contactez-nous à l’adresse indiquée dans les mentions légales.
      </p>
    </main>
  )
}

...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Create a new user
     */
    async userControllerCreateRaw(
        requestParameters: UserControllerCreateRequest,
    ...
    async userControllerCreate(
        ...
        const response = await this.userControllerCreateRaw(
            requestParameters,
            initOverrides
        );
    ...
    async userControllerFindOne(
        ...
        const response = await this.userControllerFindOneRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();
    ...
    async userControllerUpdate(
        ...
        const response = await this.userControllerUpdateRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();

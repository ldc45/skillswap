...
export class CategoriesApi extends runtime.BaseAPI {
     ...
     */
    async categoryControllerCreateRaw(
        requestParameters: CategoryControllerCreateRequest,
        ...
        const response = await this.request(
            {
                ...
                body: CreateCategoryDtoToJSON(
                    requestParameters["createCategoryDto"]
                ),
            },
            initOverrides
        );
    ...
    async categoryControllerCreate(
        ...
        const response = await this.categoryControllerCreateRaw(
            requestParameters,
            initOverrides
        );
     ...
     * Get all categories
     */
    async categoryControllerFindAllRaw(
        initOverrides?: RequestInit | runtime.InitOverrideFunction
     ...
     */
    async categoryControllerFindOneRaw(
        requestParameters: CategoryControllerFindOneRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Category>> {
    ...
    async categoryControllerFindOne(
        ...
        const response = await this.categoryControllerFindOneRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();
     ...
     */
    async categoryControllerGetCategorySkillsRaw(
        requestParameters: CategoryControllerGetCategorySkillsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
        ...
        const response = await this.request(
            {
                path: `/api/categories/{id}/skills`.replace(
                    `{${"id"}}`,
                    encodeURIComponent(String(requestParameters["id"]))
                ),
                method: "GET",
     ...
     * Get a category\'s skills
     */
    async categoryControllerGetCategorySkills(
        requestParameters: CategoryControllerGetCategorySkillsRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<Skill> {
        const response = await this.categoryControllerGetCategorySkillsRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();
     ...
     * Delete a category
     */
    async categoryControllerRemoveRaw(
        requestParameters: CategoryControllerRemoveRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    async categoryControllerRemove(
        ...
        await this.categoryControllerRemoveRaw(
            requestParameters,
            initOverrides
        );
    }
     ...
     * Update a category
     */
    async categoryControllerUpdateRaw(
        requestParameters: CategoryControllerUpdateRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<Category>> {
        if (requestParameters["id"] == null) {
            throw new runtime.RequiredError(
    ...
    async categoryControllerUpdate(
        ...
        const response = await this.categoryControllerUpdateRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();

...
export class AuthApi extends runtime.BaseAPI {
     ...
     * User logout
     */
    async authControllerLogoutRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AuthControllerLogout200Response>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => AuthControllerLogout200ResponseFromJSON(jsonValue));
    }

    /**
     * User logout
     */
    async authControllerLogout(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<AuthControllerLogout200Response> {

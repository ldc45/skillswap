...
export function CreateConversationDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateConversationDto {
    ...
    return {
        ...
        'messages': json['messages'] == null ? undefined : ((json['messages'] as Array<any>).map(CreateMessageDtoFromJSON)),
...
export function CreateConversationDtoToJSONTyped(value?: CreateConversationDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'messages': value['messages'] == null ? undefined : ((value['messages'] as Array<any>).map(CreateMessageDtoToJSON)),
